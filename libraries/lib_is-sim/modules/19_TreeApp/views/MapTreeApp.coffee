...
#                 alert "onchange3"
    ...
    _new_panel_instance: ( display_settings, data ) ->
        ...
        if data.panel_id == "TreeView"
            ...
            res.div.onmousedown = =>
                @data.focus.set @treeview.process_id
                return true
            return res
        ...
        if data.panel_id == "MapView"
            res = new MapManagerPanelInstance @el, @data, view_item, @undo_manager
            return res
        ...
        return new MapManagerPanelInstance @el, @data, view_item, @undo_manager

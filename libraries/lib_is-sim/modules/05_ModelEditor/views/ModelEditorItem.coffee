...
class ModelEditorItem extends View
    @default_types: [
        ...
        ( model ) -> ModelEditorItem_TextArea        if model instanceof Text
        #( model ) -> ModelEditorItem_TextArea        if model instanceof Obj
        ...
        ( model ) -> ModelEditorItem_MoveButtons     if model instanceof MoveButtons
    ]

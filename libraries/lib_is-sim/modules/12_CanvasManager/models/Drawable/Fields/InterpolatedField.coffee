...
#         console.log @_data.length
        for t, n in @_data
#             console.log t.pos[ 0 ].axe_name.get()
#             console.log t.pos[ 0 ].axe_value.get()
    ...
    draw: ( info, parameters, additionnal_parameters ) ->
        ...
        #@_data[@_data.length - 1]._mesh.draw info, parameters, additionnal_parameters
        f = @get_sub_field info
        if f?
...
#         console.log 'interpolated sub canvas'
    ...
    warp_gl_buff: ( info, el, buff_id ) ->
        f = @get_sub_field info
        f.warp_gl_buff info, el, buff_id
